...
var big_title = document.querySelector(".big_title");
var header = document.querySelector("header");
var content = document.querySelector(".content");
var section = document.querySelector("section");
var image_container = document.querySelector(".imgContainer");
...
window.addEventListener("scroll", function () {
  ...
  var sectionY = section.getBoundingClientRect();
  ...
  opacity.forEach(function (element) {
    element.style.opacity = scroll / (sectionY.top + section_height) + 0.1;
  });
  big_title.style.opacity = -scroll / (header_height / 2) + 1;
  content.style.transform = "translateY(".concat(scroll / (section_height + sectionY.top) * 50 - 50, "px)");
  image_container.style.transform = "translateY(".concat(scroll / (section_height + sectionY.top) * -100 + 100, "px)");
  border.style.width = "".concat(scroll / (sectionY.top + section_height) * 30, "%");
});
